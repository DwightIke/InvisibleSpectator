 ...
 */
#define MODULE_NAME "InvisibleSpectator"
#define MODULE_VERSION "1.0a"
#define MODULE_AUTHOR "Dwight (www.Pronion.ro)"
#define MODULE_URL "www.pronion.ro"
#define MODULE_LOGTAG "IS"
#define MODULE_LIBRARY "IS"
